...
Invoke-WebRequest -UseBasicParsing "https://raw.githubusercontent.com/Rnrezanur/Stream-Command-Center/main/obs-agent.js?v=$cacheBuster" -OutFile (Join-Path $agentDir "obs-agent.js")
